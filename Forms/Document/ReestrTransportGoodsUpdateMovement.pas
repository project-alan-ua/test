unit ReestrTransportGoodsUpdateMovement;
...
var
  ReestrTransportGoodsUpdateMovementForm: TReestrTransportGoodsUpdateMovementForm;

implementation

{$R *.dfm}
initialization
  RegisterClass(TReestrTransportGoodsUpdateMovementForm);
end.
