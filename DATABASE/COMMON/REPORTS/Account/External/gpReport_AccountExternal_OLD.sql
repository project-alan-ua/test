-- Function: gpReport_AccountExternal222 ()

DROP FUNCTION IF EXISTS gpReport_AccountExternal222 (TDateTime, TDateTime, Integer, TVarChar);

CREATE OR REPLACE FUNCTION gpReport_AccountExternal222 (
...
-- тест
-- SELECT * FROM gpReport_AccountExternal222 (inStartDate:= '01.09.2020', inEndDate:= '30.09.2020', inAccountId:= 0, inSession:= zfCalc_UserAdmin());
